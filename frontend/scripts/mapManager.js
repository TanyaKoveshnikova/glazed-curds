...
function addMarkers() {
    readTextFile("sources/districts.json", function (text) {
        ...
        readTextFile("sources/correspondency_matrix.json", function (text2) {
...
function drawMarkerCluster() {
    let vaccinationCLuster = new MarkerClusterer(
        this.map,
        markers,
// можно добавить свои картинки для отдаления
    );
} // Отрисовка кластера
